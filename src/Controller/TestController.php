...
//         /*
//             $army1 = new Army('Armée 1', $guerrierList1, $archerList1, $chevalierList1);
...
//             $army2 = new Army('Armée 2', $guerrierList2, $archerList2, $chevalierList2);
//       */

//             $armyFactory = new ArmyFactory();
//             $army1 = $armyFactory->create('Armée 1');
//             $army2 = $armyFactory->create('Armée 2');
...
//         return $this->render('base.html.twig', ['army1' => $army1, 'army2' => $army2, 'startBattle'=> $startBattle, 'winner'=> $    return $army1->getTotalDamage() > $army2->getTotalDamage() ? $army1 : $army2;, ] );
...
//    }	
  ...
  */
   public function persoAction()
   {
        ...
        $army1 = $this->get('army1');
        $army2 = $this->get('army2');

        $startBattle = $this->get('fightGen')->startingArmy($army1, $army2);
        $winner = $this->get('fightGen')->fight($army1, $army2);
